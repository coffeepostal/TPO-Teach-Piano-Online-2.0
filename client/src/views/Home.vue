...
#header {
  ...
  #header-controls {
    ...
    $bar-vert-position-top: $container-vert-center - 7 - ($arrow-thickness / 2) -
      ($base-gap / 2);
    ...
    a {
      .control {
        ...
        #bar-1 {
          transform: translate($bar-horz-position-left, $bar-vert-position-top)
            rotate(-$base-rotation);
          transform-origin: 100% 50%;
        }
        #bar-2 {
          transform: translate($bar-horz-position-right, $bar-vert-position-top)
            rotate($base-rotation);
